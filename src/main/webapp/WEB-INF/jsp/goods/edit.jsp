...
<script type="text/javascript">
	var error = "${error}";
	 var yy="${site.yy}";//是否预约是选择按钮，需要通过js来设置用户已经选择的值，
								//避免用户出错时再次选择 
...
<!-- 引入自己的js -->
<script type="text/javascript" language="javascript"
	src="assets/site/edit.js"></script>
</head>
<!-- 身体部分 -->
<body>
	<div class="container">
		<fieldset>
			<legend align="center">修改商品信息</legend>
			...
			<form class="ware-form" action="ware/edit" method="post" >
			<div>
					<label for="id">入库编号:</label> <input type="text"
						name="id" id="id" readonly="readonly"  value="${site.id}">
				</div>
			
				<div>
					<label for="goodsId">商品编号:</label> <input type="text"
						name="goodsId" id="goodsId" placeholder="请输入商品编号" value="${site.goodsId }">
				</div>
				<div>
					<label for="name">商品名称:</label> <input type="text" name="name"
						id="name" placeholder="请输入商品名称" value="${site.name }">
				</div>
				<div>
					<label for="numb">商品数量:</label> <input type="text" name="numb"
						id="numb" placeholder="请输入商品数量" value="${site.numb }" >
				</div>
				<div>
					<label for="start">入库日期:</label> <input type="text" name="start"
						id="start" placeholder="请选择入库日期" value="${site.localStart }" autocomplete="off">
				</div>
				<div>
					<label for="end">出库日期:</label> <input type="text" name="end"
						id="end" placeholder="请选择出库日期" value="${site.localEnd }" autocomplete="off">
				</div>
				<div>
					<label for="names">联系人:</label> <input type="text" name="names"
						id="names" placeholder="请输入联系人" value="${site.names }">
				</div>
				<div>
					<label for="phone">联系电话:</label> <input type="text" name="phone"
						id="phone" placeholder="请输入联系电话" value="${site.phone }">
				</div>
				<div class="sfyy">
